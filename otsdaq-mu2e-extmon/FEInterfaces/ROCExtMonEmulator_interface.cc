#include "otsdaq-mu2e-extmon/FEInterfaces/ROCExtMonEmulator.h"
...
#define __MF_SUBJECT__ "FE-ROCExtMonEmulator"


//=========================================================================================
ROCExtMonEmulator::ROCExtMonEmulator(
			   const std::string& rocUID,
			   const ConfigurationTree& theXDAQContextConfigTree,
			   const std::string& theConfigurationPath)
: ROCCoreVEmulator			(rocUID,theXDAQContextConfigTree,theConfigurationPath)
{
	INIT_MF("ROCExtMonEmulator");
...
//==========================================================================================
ROCExtMonEmulator::~ROCExtMonEmulator(void)
{
}

//==================================================================================================
void ROCExtMonEmulator::writeRegister(unsigned address, unsigned data_to_write)
{
...
//==================================================================================================
int ROCExtMonEmulator::readRegister(unsigned address)
{
	//lockout member variables for the remainder of the scope
	//this guarantees the emulator thread can safely access the members
	//	Note: the ROCCoreVEmulator locks before calling emulatorWorkLoop
...
bool ROCExtMonEmulator::emulatorWorkLoop(void)
{	
...
DEFINE_OTS_INTERFACE(ROCExtMonEmulator)
