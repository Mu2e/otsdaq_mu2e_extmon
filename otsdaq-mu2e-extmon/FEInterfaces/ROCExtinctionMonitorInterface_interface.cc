...
//==================================================================================================
void ROCExtinctionMonitorInterface::writeROCRegister(unsigned address,
...
//==================================================================================================
int ROCExtinctionMonitorInterface::readROCRegister(unsigned address) {
...
//============================================================================================
void ROCExtinctionMonitorInterface::writeEmulatorRegister(
...
//==================================================================================================
int ROCExtinctionMonitorInterface::readEmulatorRegister(unsigned address) {
...
//==================================================================================================
int ROCExtinctionMonitorInterface::readTimestamp() {
  return this->readRegister(12);
}

//==================================================================================================
void ROCExtinctionMonitorInterface::writeDelay(unsigned delay) {
