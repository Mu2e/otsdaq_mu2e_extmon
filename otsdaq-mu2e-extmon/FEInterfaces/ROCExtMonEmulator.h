#ifndef _ots_ROCExtMonEmulator_h_
#define _ots_ROCExtMonEmulator_h_
...
class ROCExtMonEmulator : public ROCCoreVEmulator
{

public:
	ROCExtMonEmulator (const std::string& rocUID,
			const ConfigurationTree& theXDAQContextConfigTree,
			const std::string& interfaceConfigurationPath);

	~ROCExtMonEmulator(void);
